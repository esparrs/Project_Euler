...
while len(prime_list) != 10001:
	lower_prime_problem_7 = (6*counter_problem_7)-1
	upper_prime_problem_7 = (6*counter_problem_7)+1
	if check_prime(lower_prime_problem_7) == True and len(prime_list) != 10001:
		prime_list.append(lower_prime_problem_7)
	if check_prime(upper_prime_problem_7) == True and len(prime_list) != 10001:
		prime_list.append(upper_prime_problem_7)
	counter_problem_7 += 1
...
# let us not forget our side equalities:
# a + b > c -> only important one
# a + c > b
# b + c > a
...
# where should we start with a and b?

# screw it, let's just start with a = 100

var_a_problem_nine = 100
abc_problem_nine = (0,0,0)
problem_nine_bool = False

while problem_nine_bool != True:
	print "a: " + str(var_a_problem_nine)
	var_b_problem_nine = var_a_problem_nine + 1
	print "b: " + str(var_b_problem_nine)
	var_c_problem_nine = 1000 - var_a_problem_nine - var_b_problem_nine
	print "c: " + str(var_c_problem_nine)
	while var_b_problem_nine < var_c_problem_nine:
		if var_a_problem_nine + var_b_problem_nine > var_c_problem_nine:
			if var_a_problem_nine**2 + var_b_problem_nine**2 == var_c_problem_nine**2:
				abc_problem_nine = (var_a_problem_nine,var_b_problem_nine,var_c_problem_nine)
				print abc_problem_nine
				problem_nine_bool = True
		var_b_problem_nine += 1
		var_c_problem_nine = 1000 - var_a_problem_nine - var_b_problem_nine
	var_a_problem_nine += 1
print abc_problem_nine[0] * abc_problem_nine[1] * abc_problem_nine[2]
...
counter_problem_10 = 3
sum_primes_problem_10 = (2+3+5+7+11+13)
while (6*counter_problem_10 - 1) <= 2000000:
	lower_prime_problem_10 = (6*counter_problem_10)-1
	upper_prime_problem_10 = (6*counter_problem_10)+1
	if check_prime(lower_prime_problem_10) == True and (6*counter_problem_10 - 1) < 2000000:
		sum_primes_problem_10 += lower_prime_problem_10
	if check_prime(upper_prime_problem_10) == True and (6*counter_problem_10 + 1) < 2000000:
		sum_primes_problem_10 += upper_prime_problem_10
	counter_problem_10 += 1
print sum_primes_problem_10
